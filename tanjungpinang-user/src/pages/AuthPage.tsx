  ...
  const onGoogleLogin = async (credential?: string) => {
    ...
    try {
      ...
      toast({
        title: "Login Google gagal",
        description:
          "Tidak bisa terhubung ke server. Pastikan endpoint /api/auth/google sudah dibuat di backend.",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
        ...
        <div className="w-full flex justify-center">
          <GoogleLogin
            ...
            onError={() => {
              toast({
                title: "Login Google gagal",
                description: "Akun Google gagal diproses.",
                variant: "destructive",
              });
            }}
            useOneTap={false}
            ...
            >
              <div className="bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-2xl max-w-md">
                ...
                <p className="text-white/90 italic mb-4">
                  "Aplikasi ini sangat membantu saya menemukan kuliner lokal
                  yang luar biasa dan tempat bersejarah yang belum pernah saya
                  ketahui sebelumnya!"
                </p>
